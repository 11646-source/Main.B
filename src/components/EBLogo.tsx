...
export default function EBLogo({ className = 'w-6 h-6' }: EBLogoProps) {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
      ...
      className={className}
    >
      {/* Background subtle glow/aesthetic circle if needed, or pure clean path */}
      {/* Left-pointing E bars */}
      <path
